...
public class MyProfileDropDown extends BrowserUtility {
	...
	public static void main(String[] args) throws Exception {
		...
		waitForPageElementToVisible(driver.findElement(By.id("publisherAttachTextPost")));
		...
		Thread.sleep(3000);
		WebElement postText = driver.findElement(By.xpath("//iframe[@class='cke_wysiwyg_frame cke_reset']"));
		Thread.sleep(3000);
